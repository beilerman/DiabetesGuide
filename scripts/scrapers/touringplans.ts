 ...
 */
async function getRestaurantLinks(page: Page, parkUrl: string): Promise<RestaurantInfo[]> {
 ...
 */
async function getMenuItems(page: Page, restaurantUrl: string): Promise<ScrapedRestaurant['items']> {
