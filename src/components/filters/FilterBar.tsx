...
export function FilterBar({ filters, onChange }: Props) {
  // Auto-open the advanced panel on mount when any advanced filter is already
  // active, so a shared/restored URL state is visible without the user having
  // to find the toggle. Lazy initializer runs once on mount.
  ...
  return (
    <div className="sticky top-0 z-40 bg-stone-50/95 backdrop-blur-md border-b border-stone-200 shadow-sm">
      <div className="p-4 space-y-3">
        ...
        {/* Grade pills + primary quick filters in one row */}
        <div className="flex items-center gap-2 flex-wrap">
          ...
          {/* Primary quick filters: low-carb + vegetarian (most-used) */}
          <button
        ...
        <div className="flex items-center justify-between gap-2">
          ...
          >
            ...
            {advancedActiveCount > 0 && (
              <span className="inline-flex items-center justify-center min-w-5 h-5 px-1.5 bg-teal-600 text-white text-[10px] font-bold rounded-full">
                {advancedActiveCount}
              </span>
            )}
          </button>
        ...
        {showAdvanced && (
          <div id="advanced-filters" className="space-y-3 pt-1 border-t border-stone-200">
