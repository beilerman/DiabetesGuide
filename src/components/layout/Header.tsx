...
export function Header() {
  return (
    <header className="bg-cream/85 backdrop-blur border-b border-stone-200/60 sticky top-0 z-50">
      <nav aria-label="Top navigation" className="mx-auto flex max-w-7xl items-center justify-between px-4 py-3">
        {/* Logo */}
        <Link to="/" aria-label="DiabetesGuide home" className="flex items-center gap-2 text-teal-700 hover:text-teal-800 transition-colors">
          ...
          <span className="font-display text-2xl font-bold leading-none">DiabetesGuide</span>
        </Link>
